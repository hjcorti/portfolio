...
<body id="index" class="d-flex flex-column h-100">
    ...
    <main class="container hero-home">
        ...
        <div class="row">
            <div class="col-12 col-sm-8 my-4 mt-sm-5 text-center mb-3 offset-sm-2">
                <p class="p-1 my-3 hero-badge">Jefe de soporte técnico | En camino a Full Stack Developer</p>
                <h1 class="hero-title">Tecnología, sistemas y soluciones con mirada de desarrollo.</h1>
                <p class="hero-subtitle">Soy Hugo Javier Corti, con experiencia en soporte técnico, redes y gestión de sistemas, y actualmente profundizando en programación web Full Stack.</p>
            </div>
        </div>
